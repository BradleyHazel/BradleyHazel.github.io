...
//fs.readFile(file_location, (err, data) => {
    ...
    stringData = stringData.replaceAll(`<setupCustom:selectRecordType`,`Custom Record Type: `);
    stringData = stringData.replaceAll(`</setupCustom:selectRecordType>`,``);
    stringData = stringData.replaceAll(`<setupCustom:defaultSelection`,`Default Selection: `);
    stringData = stringData.replaceAll(`<setupCustom:appliesToCustomer>`,`Applies to Customer: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToCustomer>`,``);
    stringData = stringData.replaceAll(`<setupCustom:appliesToProject>`,``);
    stringData = stringData.replaceAll(`</setupCustom:appliesToProject>`,``);          
    stringData = stringData.replaceAll(`<setupCustom:appliesToVendor>`,`Applies to Vendor: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToVendor>`,``);
    stringData = stringData.replaceAll(`<setupCustom:appliesToEmployee>`,`Applies to Employee: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToEmployee>`,``);
    stringData = stringData.replaceAll(`<setupCustom:appliesToOtherName>`,`Applies to Other Name: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToOtherName>`,``)
    stringData = stringData.replaceAll(`<setupCustom:appliesToContact>`,`Applies to Contract: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToContact>`,``);
    stringData = stringData.replaceAll(`<setupCustom:appliesToPartner>`,`Applies to Partner: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToPartner>`,``);
    stringData = stringData.replaceAll(`<setupCustom:appliesToGroup>`,`Applies to Group: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToGroup>`,``);
    stringData = stringData.replaceAll(`<setupCustom:availableExternally>`,`Available Externally: `);
    stringData = stringData.replaceAll(`</setupCustom:availableExternally>`,``);
    stringData = stringData.replaceAll(`<setupCustom:appliesToStatement>`,`Applies to Statement: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToStatement>`,``);
    stringData = stringData.replaceAll(`<setupCustom:appliesToPriceList>`,`Applies to Price List: `);
    stringData = stringData.replaceAll(`</setupCustom:appliesToPriceList>`,``);
    ...
    stringData = stringData.replaceAll(`xsi:type="platformCore:MultiSelectCustomFieldRef`,``);
